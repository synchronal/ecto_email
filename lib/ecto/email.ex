defmodule Ecto.Email do
  # @related [test](test/ecto/email_test.exs)
  @moduledoc """
  ...
  The schema should specify the field as an `Ecto.Email`. This will
  ...
  Email address fields using `Ecto.Email` should use a database column type
